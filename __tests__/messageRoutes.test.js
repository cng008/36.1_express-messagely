...
const app = require('../express-messagely-solution/app');
const db = require('../express-messagely-solution/db');
const User = require('../express-messagely-solution/models/user');
const Message = require('../express-messagely-solution/models/message');
